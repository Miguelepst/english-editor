...
def main():
    ...
    print(f"{Colors.BOLD}🚀 INICIANDO PIPELINE CI/CD - SPS 01: ORCHESTRATION{Colors.ENDC}")
    ...
    if not success:
        ...
        print(f"{Colors.WARNING}⚠️  Advertencias de estilo detectadas (No bloqueante por ahora){Colors.ENDC}")
